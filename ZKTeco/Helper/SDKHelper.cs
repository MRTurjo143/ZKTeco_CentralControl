...
namespace StandaloneSDKDemo
{
    public class SDKHelper
    {
        ...
        //public IActionResult RTData(List<string> rt ) {
        //    _httpContextAccessor.HttpContext.Session.SetString("", "Jarvik");
        //    return (rt);
        //}
        ...
        #endregion
        #region UesrFP
        public List<HR_ZktFinger_unilever> GetAllUserFPInfo()
        {
            List<HR_ZktFinger_unilever> Vml = new();
            if (GetConnectState() == false)
            {
            ...
            while (axCZKEM1.SSR_GetAllUserInfo(iMachineNumber, out sEnrollNumber, out sName, out sPassword, out iPrivilege, out bEnabled))//get all the users' information from the memory
            {
                ...
                for (idwFingerIndex = 0; idwFingerIndex < 10; idwFingerIndex++)
                {
                    if (axCZKEM1.GetUserTmpExStr(iMachineNumber, sEnrollNumber, idwFingerIndex, out iFlag, out sFPTmpData, out iFPTmpLength))//get the corresponding templates string and length from the memory
                    {
                        ...
                        {
                            fingerCount += 1;
                            switch (idwFingerIndex)
                            {
                                case 0:

                                    Vm.fingerindex1 = sFPTmpData == null ? "Null" : sFPTmpData;
                                    break;
                                case 1:
                                    Vm.fingerindex2 = sFPTmpData == null ? "Null" : sFPTmpData;
                                    break;
                                case 2:
                                    Vm.fingerindex3 = sFPTmpData == null ? "Null" : sFPTmpData;
                                    break;
                                case 3:
                                    Vm.fingerindex4 = sFPTmpData == null ? "Null" : sFPTmpData;
                                    break;
                                case 4:
                                    Vm.fingerindex5 = sFPTmpData == null ? "Null" : sFPTmpData;
                                    break;
                                case 5:
                                    Vm.fingerindex6 = sFPTmpData == null ? "Null" : sFPTmpData;
                                    break;
                                case 6:
                                    Vm.fingerindex7 = sFPTmpData == null ? "Null" : sFPTmpData;
                                    break;
                                case 7:
                                    Vm.fingerindex8 = sFPTmpData == null ? "Null" : sFPTmpData;
                                    break;
                                case 8:
                                    Vm.fingerindex9 = sFPTmpData == null ? "Null" : sFPTmpData;
                                    break;
                                case 9:
                                    Vm.fingerindex10 = sFPTmpData == null ? "Null" : sFPTmpData;
                                    break;
                            }
                        }
                    }
        ...
        public int sta_SetAllUserFPInfo(List<ZKTDataTranVM> lvUserInfos)
        {
            if (GetConnectState() == false)
            {
            ...
            Tz = "00002359000023590000235900002359000023590000235900002359";
            ...
            Tz = "00002359000023590000235900002359000023590000235900000000";
            axCZKEM1.SetTZInfo(iMachineNumber, 7, Tz);

            Tz = "00000000000023590000235900002359000023590000235900002359";
            axCZKEM1.SetTZInfo(iMachineNumber, 8, Tz);
            ...
            foreach (var lvUserInfo in lvUserInfos)
            {
                ...
                sEnrollNumber = lvUserInfo.empCode;
                //if (Regex.IsMatch(sEnrollNumber, "[a-zA-Z]"))
                //{
                //    continue;
                //}
                sName = lvUserInfo.empName; 
                sCardnumber = id.ToString();
                sPassword = "";
                if (lvUserInfo.weekday != null && lvUserInfo.weekday> 0)
                {
                    sFlag = "";
                }
                else { sFlag = "1"; }
                ...
                if (sEnrollNumber != null)
                {
                    if (axCZKEM1.SSR_SetUserInfo(iMachineNumber, sEnrollNumber, sName, sPassword, iPrivilege, bEnabled))//upload user information to the device
                    {
                        if (sFlag == "1")
                        {
                            ...
                            if (lvUserInfo.fingerindex1 != null)
                            {
                                idwFingerIndex = 0;
                                iFlag = Convert.ToInt32(sFlag);
                                sFPTmpData = lvUserInfo.fingerindex1;
                            ...
                            if (lvUserInfo.fingerindex2 != null)
                            {
                                idwFingerIndex = 1;
                                iFlag = Convert.ToInt32(sFlag);
                                sFPTmpData = lvUserInfo.fingerindex2;
                                axCZKEM1.SetUserTmpExStr(iMachineNumber, sEnrollNumber, idwFingerIndex, iFlag, sFPTmpData);//upload templates information to the device
                            }
                            if (lvUserInfo.fingerindex3 != null)
                            {
                                idwFingerIndex = 2;
                                iFlag = Convert.ToInt32(sFlag);
                                sFPTmpData = lvUserInfo.fingerindex3;
                                axCZKEM1.SetUserTmpExStr(iMachineNumber, sEnrollNumber, idwFingerIndex, iFlag, sFPTmpData);//upload templates information to the device
                            }
                            if (lvUserInfo.fingerindex4 != null)
                            {
                                idwFingerIndex = 3;
                                iFlag = Convert.ToInt32(sFlag);
                                sFPTmpData = lvUserInfo.fingerindex4;
                                axCZKEM1.SetUserTmpExStr(iMachineNumber, sEnrollNumber, idwFingerIndex, iFlag, sFPTmpData);//upload templates information to the device
                            }
                            if (lvUserInfo.fingerindex5 != null)
                            {
                                idwFingerIndex = 4;
                                iFlag = Convert.ToInt32(sFlag);
                                sFPTmpData = lvUserInfo.fingerindex5;
                                axCZKEM1.SetUserTmpExStr(iMachineNumber, sEnrollNumber, idwFingerIndex, iFlag, sFPTmpData);//upload templates information to the device
                            }
                            if (lvUserInfo.fingerindex6 != null)
                            {
                                idwFingerIndex = 5;
                                iFlag = Convert.ToInt32(sFlag);
                                sFPTmpData = lvUserInfo.fingerindex6;
                                axCZKEM1.SetUserTmpExStr(iMachineNumber, sEnrollNumber, idwFingerIndex, iFlag, sFPTmpData);//upload templates information to the device
                            }
                            if (lvUserInfo.fingerindex7 != null)
                            {
                                idwFingerIndex = 6;
                                iFlag = Convert.ToInt32(sFlag);
                                sFPTmpData = lvUserInfo.fingerindex7;
                                axCZKEM1.SetUserTmpExStr(iMachineNumber, sEnrollNumber, idwFingerIndex, iFlag, sFPTmpData);//upload templates information to the device
                            }
                            if (lvUserInfo.fingerindex8 != null)
                            {
                                idwFingerIndex = 7;
                                iFlag = Convert.ToInt32(sFlag);
                                sFPTmpData = lvUserInfo.fingerindex8;
                                axCZKEM1.SetUserTmpExStr(iMachineNumber, sEnrollNumber, idwFingerIndex, iFlag, sFPTmpData);//upload templates information to the device
                            }
                            if (lvUserInfo.fingerindex9 != null)
                            {
                                idwFingerIndex = 8;
                                iFlag = Convert.ToInt32(sFlag);
                                sFPTmpData = lvUserInfo.fingerindex9;
                                axCZKEM1.SetUserTmpExStr(iMachineNumber, sEnrollNumber, idwFingerIndex, iFlag, sFPTmpData);//upload templates information to the device
                            }
                            if (lvUserInfo.fingerindex10 != null)
                            {
                                idwFingerIndex = 9;
                                iFlag = Convert.ToInt32(sFlag);
                                sFPTmpData = lvUserInfo.fingerindex10;
                                axCZKEM1.SetUserTmpExStr(iMachineNumber, sEnrollNumber, idwFingerIndex, iFlag, sFPTmpData);//upload templates information to the device
                            }
                        ...
                        if (lvUserInfo.weekday != null && lvUserInfo.weekday > 0)
                        {
                            ...
                            userGroup = (int)lvUserInfo.weekday;
                            var userId = Convert.ToInt32(sEnrollNumber);
                            ...
                            {
                                axCZKEM1.SetUserTZStr(iMachineNumber, userId, "8:0:0:1");
        ...
        public int sta_SetSuperAdmin(List<viewModel> lvUserInfos)
        {
            if (GetConnectState() == false)
            {
        ...
        /// <summary>
        /// Disable User
        public List<viewModel> BlockUser(List<viewModel> lvUserInfos)
        {
            List<viewModel> vml = new();
            ...
            Tz = "00000000000000000000000000000000000000000000000000000000";
            axCZKEM1.SetTZInfo(iMachineNumber, 10, Tz);
            ...
            foreach (var lvUserInfo in lvUserInfos)
            {
                ...
                if (sEnrollNumber != null)
                {
                    ...
                    var userId = Convert.ToInt32(sEnrollNumber);
                    axCZKEM1.SetUserTZStr(iMachineNumber, userId, "10:0:0:1");

                    viewModel bl = new viewModel();
                   
                    bl.EmpCode = sEnrollNumber;
                    bl.EmpName = sName;
        ...
        /// Unblock User
        /// </summary>
        public List<viewModel> UnBlockUser(List<viewModel> lvUserInfos)
        {
            List<viewModel> vml = new();
